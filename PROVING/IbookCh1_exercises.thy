...
(* jfh: what follows are lots of small lemmas leading to a proof of the triangle inequality; it's
here because you'll be using in the homework for chapter 2 *)
...
(* jfh: to simplify the proof of the triangle inequality,
I have broken it into four cases, wiht names ti1, ti2, ti3, ti4
where we consider the various cases for the signs of a and b.
Many of the proofs were found by sledgehammer. 
*)
lemma ti1:
  fixes a::r and  b
