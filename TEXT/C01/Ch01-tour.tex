...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{C01//Images/interface-update.png}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=0.75\linewidth]{C01//Images/sorry-result.png}
\end{figure}

And down in the \sys{Output} panel you'll get a result:

\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{C01//Images/result.png}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=0.5\linewidth]{C01//Images/try0.png}
\end{figure}
