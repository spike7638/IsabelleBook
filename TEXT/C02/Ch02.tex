...
At some point you may find yourself trying to do a proof by cases, perhaps when you're trying to show something like \isi{abs x ≥ 0}. You start your proof with 
\begin{IS}
    proof (cases "x \in P")
\end{IS}
